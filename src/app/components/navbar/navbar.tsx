...
export default function Navbar() {
  ...
  return (
    <div className="navbar">
      <div className="nav">
        <Link href="/" className="logo"><h1>Kaustubh<span className="dot">.</span></h1></Link>
        <ul>
          <li className="home">
            <Link href="/" id="home">
              <span className="svgForMobile">
                <svg aria-label="Home" className="_8-yf5" fill="white" height="22" viewBox="0 0 48 48" width="22">
          ...
          <li className="project">
            {/* activeStyle={{color:'#cf000f'}} */}
            <Link href="/project" id="project" >
              <span className="svgForMobile">
                <svg version="1.0"
