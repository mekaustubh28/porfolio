...
import Mail_White from "../../../../public/statics/mail_white.svg"
import LogoRed from "../../../../public/statics/logored.svg"
import LogoWhite from "../../../../public/statics/logo_white.svg"
  ...
  return (
    <>
      <div className="navbar">
        <div className="nav">
          <Link href="/" className="logo"><h1 className="text-3xl">Kaustubh<span className="dot">.</span></h1></Link>
          <ul>
            <li className="home">
              <Link href="/" id="home" className={`${pathname === '/' ? 'active' : ''}`}>
                <svg aria-label="Home" className="_8-yf5 svgForMobile m-auto" fill={`${pathname === '/' ? '#cf000f' : 'white'}`} height="18" viewBox="0 0 48 48" width="18">
                ...
                <span className="name_hide">Home</span>
              </Link>
            </li>
            <li className="project">
              <Link href="/project" id="project" className={`${pathname === '/project' ? 'active' : ''}`}>
                <svg version="1.0" className="svgForMobile m-auto" height="18" viewBox="0 0 1280.000000 853.000000"
                  preserveAspectRatio="xMidYMid meet">
                  <g transform="translate(0.000000,853.000000) scale(0.100000,-0.100000)"
                    fill={`${pathname === '/project' ? '#cf000f' : 'white'}`} stroke="none">
                ...
                <span className="name_hide">Project</span>
              </Link>
            </li>
            <li className="contact">
              <Link href="/contact" className={`${pathname === '/contact' ? 'active' : ''}`} >
                <Image src={pathname === '/contact' ? Mail : Mail_White} className="m-auto svgForMobile" alt="My Logo" width={23} height={23} />
                <span className="name_hide">Contact</span>
              </Link>
            </li>
            <li className="about">
              <Link href="/about" id="about" className={`${pathname === '/about' ? 'active' : ''}`}>
                <Image src={pathname === '/about' ? LogoRed : LogoWhite} className="m-auto svgForMobile" alt="My Logo" width={18} height={18} />
                <span className="name_hide">About</span>
              </Link>
            </li>
          </ul>
        </div>
        <Link className="mail hover" href="/contact">
          <Image src={Mail} alt="My Logo" width={35} height={35} />
        </Link>
        <div className="social">
          <a href="https://www.instagram.com/kaus._.tubh/" target="_blank" rel="noreferrer">
